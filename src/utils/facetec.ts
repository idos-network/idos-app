...
export class MyApp {
    ...
    public init = (): void => {
        ...
        if (!this.FaceTecSDK) {
            console.error("FaceTecSDK is not loaded. Make sure the script is included in your HTML.");
            return;
        }

        this.FaceTecSDK.setResourceDirectory("../../core-sdk/FaceTecSDK.js/resources");
        this.FaceTecSDK.setImagesDirectory("../../core-sdk/FaceTecSDK.js/FaceTec_images");
        this.FaceTecSDK.initializeInDevelopmentMode(Config.DeviceKeyIdentifier, Config.PublicFaceScanEncryptionKey, (initializationSuccess: boolean) => {
    ...
    private setupCustomization = (): void => {
        ...
        currentCustomization.guidanceCustomization.buttonBackgroundNormalColor = "#3b82f6";
        currentCustomization.guidanceCustomization.buttonBackgroundHighlightColor = "#2563eb";
        currentCustomization.guidanceCustomization.buttonBackgroundDisabledColor = "#9ca3af";
        currentCustomization.guidanceCustomization.buttonTextNormalColor = "#ffffff";
        currentCustomization.guidanceCustomization.buttonTextHighlightColor = "#ffffff";
        currentCustomization.guidanceCustomization.buttonTextDisabledColor = "#ffffff";
        ...
        // Cancel button
        currentCustomization.cancelButtonCustomization.location = this.FaceTecSDK.FaceTecCancelButtonLocation.TOP_RIGHT;
    ...
    public onLivenessCheckClick = (): void => {
        ...
        this.getSessionToken((sessionToken: string) => {
            ...
            const livenessCheckProcessor = new LivenessCheckProcessor(sessionToken, this);
        });
    }
