...
const timeFilters = ["1 HOUR", "1 DAY", "1 WEEK", "1 YEAR", "MAX"];
    ...
    <Card className="w-full rounded-3xl border-none bg-card text-white bg-[#26262699]">
      <CardContent className="">
        ...
        <div className="mb-6 flex flex-col gap-4 sm:mb-8 sm:flex-row sm:items-start sm:justify-between sm:gap-0">
          <h2 className="font-semibold text-white text-xl sm:text-2xl">Balance</h2>
        ...
        {/* Chart */}
        <div className="h-[160px] sm:h-[240px] md:h-[200px] ">
