        ...
        <Dialog>
            <form>
                <DialogTrigger asChild>
                    <Button className={`flex items-center gap-2 px-6! py-3 h-[45px] rounded-2xl font-medium text-sm transition-all duration-200 hover:scale-105 bg-neutral-100 text-black hover:bg-neutral-500`}><SendIcon /> Send </Button>
                </DialogTrigger>
                <DialogContent className="sm:max-w-[425px] bg-[#1A1A1A] border-none">
                    ...
                    <div className="grid gap-4 mt-4">
                        <div className="grid gap-4 mt-4">
                            <Label className="font-medium text-muted text-neutral-400">Recipient</Label>
                            <Input
                                type="text"
