            ...
            <form>
                ...
                <DialogContent className="sm:max-w-[425px] bg-[#1A1A1A] border-none">
                    <div className="flex flex-col gap-4 my-4 items-center">
                        ...
                        <span className="text-neutral-50 text-2xl font-medium">Persona</span>
                    </div>
                    <div className="flex flex-col gap-4 text-center px-6">
                        <p className='text-neutral-400 text-sm'>You’re about to submit mock sensitive data to our identity verification provider, Persona.</p>
                        <p className='text-neutral-400 text-sm'>By confirming, you agree to the Users’ Agreement,
                            and confirm you’ve read the Privacy Policy
                            and Transparency Document.</p>
                    </div>
                    <DialogFooter>
                        <DialogClose asChild>
                            <Button
