...
export function GeneralLeaderboard({
  ...
  return (
    <div className="flex h-full flex-col gap-6 overflow-hidden rounded-2xl border border-neutral-800 bg-neutral-800/60 p-6 w-full">
      <div className="flex">
        <h2 className="font-normal text-xl text-neutral-50">Leaderboard</h2>
      </div>
        ...
        <table className="w-full table-auto text-sm font-['Inter']">
          <thead>
            <tr className="text-left text-neutral-400 text-sm bg-neutral-800 h-[52px]">
              <th className="w-[10%] px-4 font-normal rounded-l-[20px]">#</th>
              <th className="w-[35%] px-4 font-normal">User</th>
              ...
              <th className="w-[10%] px-4 font-normal">Contrib.</th>
              <th className="w-[15%] px-4 font-normal rounded-r-[20px]">
                Total
              </th>
            </tr>
          </thead>
